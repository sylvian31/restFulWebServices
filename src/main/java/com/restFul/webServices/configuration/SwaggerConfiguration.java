...
public class SwaggerConfiguration {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Sylvian Caron", "", "");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Api RestFul", "Api RestFul Documentation", "1.0",
